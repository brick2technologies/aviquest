...
====================================================== */}
      <section className="py-16 md:py-24 bg-slate-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/* ===== MOBILE / TABLET ANIMATION (UNDER HEADING) ===== */}
            <Motion.div
            ...
            >
              <Motion.div
                ...
                className="font-chillax absolute 
                     w-[300px] h-[300px] 
                ...
                <svg viewBox="0 0 300 300" className="w-full h-full">
                  ...
                  >
                    <textPath href="#circlePathMobile">
                      ...
                      Innovation • Research Driven • Scientific Validation •
                    </textPath>
                  </text>
                </svg>
              </Motion.div>
            ...
            >
              ...
              <p>
                Founded with the vision to transform the poultry industry, we
                stand at the forefront of research-driven solutions. We harness
                advanced scientific knowledge and cutting-edge technology to
              ...
              <p>
                ...
                enhance overall productivity, we empower farmers to achieve
                their goals.
              </p>

              <p className="font-medium text-[#336600] italic">
                "At AviQuest Healthcare, we believe that the success of farmers
                and the health of poultry go hand in hand."
              </p>
            </Motion.div>
          </div>
          ...
          >
            <Motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 26, repeat: Infinity, ease: "linear" }}
              className="font-chillax absolute w-[600px] h-[600px]"
            >
              <svg viewBox="0 0 300 300" className="w-full h-full">
                <defs>
                  <path
      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <Motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="rounded-3xl border border-slate-200 p-10 bg-white"
          >
      ...
      {/* ================= IMPACT ================= */}
      <section className="py-24 bg-[#0071BC]/5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
            {[
              ...
              <Motion.div
                ...
                viewport={{ once: true }}
                className="rounded-2xl bg-white border border-slate-200 p-6 text-center hover:shadow-md transition-shadow"
              >
